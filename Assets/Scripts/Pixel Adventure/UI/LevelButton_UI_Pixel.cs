...
public class LevelButton_UI_Pixel : MonoBehaviour
{
    ...
    public void UpdateTextInfo(int levelNumber)
    {
        ...
        collectedFruits.text = PlayerPrefs.GetInt("Level" + levelNumber + "FruitsCollected", PlayerManager_Pixel.instance.fruits).ToString();
