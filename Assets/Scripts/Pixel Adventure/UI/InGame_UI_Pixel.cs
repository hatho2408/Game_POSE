...
public class InGame_UI_Pixel : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        PlayerManager_Pixel.instance.inGameUI = this;
    }

    private void Start()
    {
        GameManager_Pixel.instance.levelNumber = SceneManager.GetActiveScene().buildIndex;
        Time.timeScale = 1;
        SwitchUI(inGameUI);
    ...
    public void AssignPlayerControlls(Player_Pixel player)
    {
    ...
    {
        endFruitsText.text = "Fruits: " + PlayerManager_Pixel.instance.fruits;
        endTimerText.text = "Your time: " + GameManager_Pixel.instance.timer.ToString("00") + " s";
        endBestTimeText.text = "Best time: " + PlayerPrefs.GetFloat("Level" + GameManager_Pixel.instance.levelNumber + "BestTime",999).ToString("00") + " s";
    ...
    {
        timerText.text = "Timer: " + GameManager_Pixel.instance.timer.ToString("00") + " s";
        currentFruitAmount.text = PlayerManager_Pixel.instance.fruits.ToString();
    }
    ...
    {
        Time.timeScale = 1;
        SceneManager.LoadScene("Pixel_Adventure_MainMenu");
    }
