...
namespace CodeMonkey.Utils {
    ...
    public class World_Sprite {
        ...
        public static World_Sprite CreateDebugButton(Vector3 position, System.Action ClickFunc) {
            World_Sprite worldSprite = new World_Sprite(null, position, new Vector3(10, 10), Assets_ColorBird.i.s_White, Color.green, sortingOrderDefault);
        ...
        public static World_Sprite CreateDebugButton(Transform parent, Vector3 localPosition, System.Action ClickFunc) {
            World_Sprite worldSprite = new World_Sprite(parent, localPosition, new Vector3(10, 10), Assets_ColorBird.i.s_White, Color.green, sortingOrderDefault);
            worldSprite.AddButton(ClickFunc, null, null);
            return worldSprite;
        }
        public static World_Sprite CreateDebugButton(Transform parent, Vector3 localPosition, string text, System.Action ClickFunc, int fontSize = 30, float paddingX = 5, float paddingY = 5) {
            ...
            World_Sprite worldSprite = new World_Sprite(gameObject.transform, Vector3.zero, rendererBounds.size + new Vector3(paddingX, paddingY), Assets_ColorBird.i.s_White, color, sortingOrderDefault);
        ...
        public static World_Sprite Create(Vector3 worldPosition, Vector3 localScale, Color color) {
            return new World_Sprite(null, worldPosition, localScale, Assets_ColorBird.i.s_White, color, 0);
        }
        public static World_Sprite Create(Vector3 worldPosition, Vector3 localScale) {
            return new World_Sprite(null, worldPosition, localScale, Assets_ColorBird.i.s_White, Color.white, 0);
        }
        public static World_Sprite Create(Vector3 worldPosition, Vector3 localScale, int sortingOrderOffset) {
            return new World_Sprite(null, worldPosition, localScale, Assets_ColorBird.i.s_White, Color.white, sortingOrderOffset);
        }
        ...
        public Button_Sprite_ColorBird AddButton(System.Action ClickFunc, System.Action MouseOverOnceFunc, System.Action MouseOutOnceFunc) {
            gameObject.AddComponent<BoxCollider2D>();
            Button_Sprite_ColorBird buttonSprite = gameObject.AddComponent<Button_Sprite_ColorBird>();
            if (ClickFunc != null)
