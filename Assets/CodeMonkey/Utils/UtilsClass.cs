...
namespace CodeMonkey.Utils {
    ...
    public static class UtilsClass {
        ...
        public static Button_Sprite_ColorBird CreateWorldSpriteButton(string name, Sprite sprite, Vector3 localPosition, Vector3 localScale, int sortingOrder, Color color) {
        ...
        public static Button_Sprite_ColorBird CreateWorldSpriteButton(Transform parent, string name, Sprite sprite, Vector3 localPosition, Vector3 localScale, int sortingOrder, Color color) {
        ...
        public static FunctionUpdater_ColorBird CreateWorldTextUpdater(Func<string> GetTextFunc, Vector3 localPosition, Transform parent = null) {
            TextMesh textMesh = CreateWorldText(GetTextFunc(), parent, localPosition);
            return FunctionUpdater_ColorBird.Create(() => {
        ...
        public static void CreateWorldTextPopup(Transform parent, string text, Vector3 localPosition, int fontSize, Color color, Vector3 finalPopupPosition, float popupTime) {
            ...
            FunctionUpdater_ColorBird.Create(delegate () {
        ...
        [Obsolete]
        public static FunctionUpdater_ColorBird CreateUITextUpdater(Func<string> GetTextFunc, Vector2 anchoredPosition) {
        ...
        public static void DebugProjectile(Vector3 from, Vector3 to, float speed, float projectileSize) {
            ...
            Vector3 pos = from;
            FunctionUpdater_ColorBird.Create(() => {
