...
namespace CodeMonkey {
    ...
    public static class CMDebug {
        ...
        public static FunctionUpdater_ColorBird TextUpdater(Func<string> GetTextFunc, Vector3 localPosition, Transform parent = null) {
            return UtilsClass.CreateWorldTextUpdater(GetTextFunc, localPosition, parent);
        }

        // Text Updater in UI
        [Obsolete]
        public static FunctionUpdater_ColorBird TextUpdaterUI(Func<string> GetTextFunc, Vector2 anchoredPosition) {
